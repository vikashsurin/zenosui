<script lang="ts">
	import ComboboxDemo from './ComboboxDemo.svelte';
	import source from './ComboboxDemo.svelte?raw';
...
<DocLayoutBox layout={combobox.layout} />

<DocAttributes props={combobox.props} otherProps={combobox.otherProps} />
