...
type ButtonAsButton = UiProps & StateProps & IconProps & Type.HTMLAttributes<HTMLButtonElement> & {
    href?: never;
    label?: string;
};
type ButtonAsAnchor = UiProps & StateProps & IconProps & Type.HTMLAttributes<HTMLAnchorElement> & {
    href?: string;
    label?: string;
};
...
export interface SidebarItemProps extends UiProps, IconProps, Type.HTMLAttributes<HTMLAnchorElement> {
    href?: string;
}
...
export interface NavigationMenuItemProps extends UiProps, IconProps, Type.HTMLAttributes<HTMLAnchorElement> {
}
...
export interface AccordionTriggerProps extends UiProps, IconProps, Type.HTMLAttributes<HTMLButtonElement> {
    label?: string;
...
export interface SelectTriggerProps extends UiProps, IconProps, Type.HTMLAttributes<HTMLButtonElement> {
    label?: string;
}
...
export interface NavigationListItemProps extends UiProps, StateProps, IconProps, Type.HTMLAnchorAttributes {
    iconLeftOpen?: Snippet | Component;
    iconLeftClose?: Snippet | Component;
    iconRightOpen?: Snippet | Component;
    iconRightClose?: Snippet | Component;
